    ...
    <div class="content-container p-4">
        <h3 class="text-center">Edit Blog</h3><br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="blog_title" name="blog_title" placeholder="Blog Title" value="{{ $blogName->blog_title }}">
                </div>

                <div class="form-group">
                    <label for="blogLink">Link to the Blog:</label>
                    <input type="url" class="form-control" id="blog_link" name="blog_link" placeholder="Link to the Blog" value="{{ $blogName->blog_link }}">
                </div>
